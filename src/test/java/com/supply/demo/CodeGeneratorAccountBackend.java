 ...
 */
public class CodeGeneratorAccountBackend {

    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://tustorew.rwlb.rds.aliyuncs.com:3306/tustore_account?useSSL=false";
    private static final String JDBC_USERNAME = "tustore_account";
    ...
    // @author
    private static final String AUTHOR = "kwah";
    // @date
